          ...
          <div className="container">
            ...
            <div className="row">
              ...
              <div className="payment-info">
                ...
                <div className="info">
                  <div>{orderInfo.info.payment_method_name}</div>
                  <div>
                    {`Tổng giá trị sản phẩm: đ ${formatPrice(
                      orderInfo.info.total_after_discount
                    )}`}
                  </div>
                ...
                {orderInfo.info.line_items_at_time.map((v, i) => (
                  <tr key={i}>
                        ...
                        <div className="action">
                          ...
                          {orderInfo.info.order_status_code === "COMPLETED" && (
                            <React.Fragment>
                              {isReviewable(v) && (
                                <>
                                  <button onClick={() => openRattingForm(v)}>
                                    Đánh giá
                                  </button>
                                  <span> | </span>
                                </>
                    ...
                    <td className="discount">
                      ₫{" "}
                      {formatPrice(v.before_discount_price - v.after_discount)}
                    </td>
                    <td className="price">
