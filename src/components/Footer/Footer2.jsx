            ...
            <div className="footer-inner padding-top-35 pb-lg-5">
              <div className="container">
                <div className="row">
                    ...
                    <div className="footer-widget">
                      ...
                      <ul className="list-menu list-showroom">
                        ...
                        <li className="clearfix"><i className="block_icon fa fa-envelope" />
                          <a title="Dualeotheme@gmail.com" href="mailto:Dualeotheme@gmail.com">{appTheme.contact_email}</a>
                        </li>
                      </ul>
                    </div>
                  </div>
                  <div className="col-xs-12 col-sm-6 col-lg-4">
                    <div className="footer-widget">
                      <h3 className="hastog"><span>Về chúng tôi</span></h3>
                      <ul className="list-menu list-blogs">
                        <li>      <a href={appTheme.post_id_about ? `/tin-tuc/${appTheme.post_id_about}` : "/#"}
                          onClick={(e) => handlePostClick(e, appTheme.post_id_about)}
                        >
                          Giới thiệu
                        </a></li>
                        <li>    <a href={appTheme.post_id_help ? `/tin-tuc/${appTheme.post_id_help}` : "/#"}
                          onClick={(e) => handlePostClick(e, appTheme.post_id_help)}
                        >
                          Giúp đỡ
                        </a></li>
                        <li>  <a href={appTheme.post_id_terms ? `/tin-tuc/${appTheme.post_id_terms}` : "/#"}
                  ...
                  <div className="col-xs-12 col-sm-6 col-lg-4">
                    <div className="footer-widget">
                      <h3 className="hastog"><span>                Tài khoản của tôi
                      </span></h3>
                      <ul className="list-menu list-blogs">
                        {
                          tokenInfo ?
                        ...
                        <li><a href="/don-hang" onClick={checkToken}>
                          Lịch sữ đơn hàng</a></li>
                        <li>  <a href="/yeu-thich" onClick={checkToken}>
                          Sản phẩm yêu thích
                        </a></li>
